    ...
    <div>
        <div class="container">
            ...
            <div v-else-if = "status === 'LOADED'  && this.meetings.length > 0">
               <h2 class="my-2">Meetings matching search criteria</h2>
                <hr>
                <div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div style="padding-top:10px" v-if="new Date(meeting.date) >= new Date(new Date().toDateString())">
                                    ...
                                    <button type="button" class="btn btn-primary"  @click="addAttendee( meeting._id, $event )">Add</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
import { searchMeetings, excuseMeeting, addAttendee } from '@/services/meetings';
    ...
    methods: {
        ...
        async excuseMeeting( meetingId ) {
            try {
                ...
                alert(`Left Meeting ${response.name}`)
